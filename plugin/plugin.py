...
from plugin.client import FormationsClient, Spec

PLUGIN_NAME = "battlestar-formations"
PLUGIN_VERSION = "0.0.1"
TEAM_NAME = "cloudquery"
PLUGIN_KIND = "source"


class FormationsPlugin(plugin.Plugin):
    ...
    def init(self, spec, no_connection: bool = False):
        ...
        self._client = FormationsClient(self._spec)
